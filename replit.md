...
- **Premium History Filtering**: Premium members see ALL `isPremium = true` AI-generated predictions that resolved as `result = 'correct'` within the last 30 days. The free daily tip (`isPremium = false`) is excluded. Free members see completed game results from ESPN data (last 5 days, all marked correct).
